package com.mohai.one.springbootcacheredis.service;

import com.mohai.one.springbootcacheredis.dao.UserRepository;
...
public class UserService {
    ...
    public List<UserDTO> findList(Example<UserDTO> example){
